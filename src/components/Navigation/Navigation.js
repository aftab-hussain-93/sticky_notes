	...
	<nav className="bg-black dt w-100 center" style={{display: "flex", justifyContent:"flex-end"}}>
		...
		{isSignedIn?
			...
			className="f4 pointer pa0 fw6 dim no-underline white dn dib-ns mb2 ph3">Sign Out
				...
				className="f4 pointer pa0 fw6 dim no-underline white dn dib-ns mb2 ph3">Login
				</p>
				<p
				onClick={ () => onRouteChange('register') } 
				className="f4 pointer  pa0 fw6 dim no-underline white dn dib-ns mb2 ph3">Register
				</p></>}
	</nav>);
}
